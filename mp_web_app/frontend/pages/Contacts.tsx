        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4 text-justify">
            <div className="pt-4 border-t">
              ...
              <p className="mt-3">
                Членовете на кооперацията в момента са над 900 и техният брой продължава да расте. Общата площ на
                горите, стопанисвани от кооперацията, е над 26000 дка.
              </p>
              <p className="mt-3">
                Kооперацията се занимава с дърводобив и дървопреработка. Годишното производство е между 5 и
                10 хиляди куб.м дърводобив.
              </p>
              <p className="mt-3">
                ГПК Мурджов Пожар разполага със собствено предприятие за първична преработка на дървесина в с.Славеино.
              </p>
            </div>
          </CardContent>
        </Card>
