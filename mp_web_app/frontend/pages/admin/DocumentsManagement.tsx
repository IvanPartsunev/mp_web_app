          ...
          <Table className={TABLE_STYLES.tableBase}>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className={`${TABLE_STYLES.headBase} w-[30%]`}>Име на файл</TableHead>
                ...
                <TableHead className={`${TABLE_STYLES.headRight} w-[15%]`}>Действия</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredFiles.map((file, index) => (
                <TableRow key={file.id}>
                  ...
                  <TableCell className={TABLE_STYLES.cellBase}>{new Date(file.created_at).toLocaleDateString("bg-BG", {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric'
                  })}</TableCell>
                  <TableCell className={TABLE_STYLES.cellRight}>
                    <Button
                      variant="destructive"
                      size="sm"
