...
class TestCreateNews:
    ...
    def test_handles_database_error(self, mock_repo):
        ...
        mock_repo.table.put_item.side_effect = ClientError(
...
class TestUpdateNews:
    ...
    def test_updates_news_successfully(self, mock_get_news, mock_repo):
        ...
        mock_repo.table.update_item = Mock(return_value={
            "Attributes": {"id": "news123", "title": "Updated Title"}
        })
...
class TestGetNews:
    ...
    def test_gets_all_news_with_valid_token(self, mock_is_expired, mock_repo):
        ...
        mock_repo.table.query = Mock(return_value={
            "Items": [
                {"id": "1", "news_type": "regular"},
                {"id": "2", "news_type": "private"}
            ]
        })
